...
public class MvcConfiguration extends WebMvcConfigurerAdapter {
    ...
    public EmbeddedServletContainerFactory servletContainer() {
        ...
        tomcat.setPort(8090);
        tomcat.setContextPath("/CrystalReports");
    ...
    public ServletRegistrationBean dispatcherServletRegistration() {
        ServletRegistrationBean registrationBean = new ServletRegistrationBean(new DispatcherServlet());
        ...
        registrationBean.addInitParameter("contextConfigLocation","com.lister.Project.config.MvcConfiguration");
